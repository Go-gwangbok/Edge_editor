<div class="container" style="margin-top:-15px;">	
    ...
    <div class="row">
    	...
    	foreach ($memlist as $value) {
		    ...
		    $pecent = round(($done_count/$history)*100);		    
		    $pecent_other = round(($done_count/$history)*100,1);		    
    	?>
    	<div class="col-md-4">
    		<div class="col-md-12 line" style="height:52px; background-color:#394263; border:2px; padding-top:5px;">
    			...
    			<p class="text-right" style="margin-top:3px;"><font color="#fff" size="2px"><?=$date;?></font></p>
    		</div>    		
    		<div class="col-md-12 line" style="height:110px; margin-bottom:20px;">
    			<font size="2px;">Completed</font>
