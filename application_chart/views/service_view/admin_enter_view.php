<div class="container" style="margin-top:-15px;">		
	<div class="row">		
		<ol class="breadcrumb" style="background:white;">
	    	...
	    	<li class="akacolor"><?=$str_month;?></li>   	       	
	    </ol>
...
function ajaxPost(url,data){
	$.post(url,data,function(json) {				
		...
		for(var i = 0; i < json['data_list'].length; i++) {
			...
			$('tbody#list').append('<tr id='+i+' class="rowbtn" href="/text_editor/service_comp/'+essay_id+'/'+task+'/'+month+'/'+year+'"><td class="text-center">'+num+'</td><td>'																				 
				...
				+data_list[i]['type']+'</td><td width="80px;" class="text-center"><font class="comp">Completed</font></a></td>');					
			num++;			
		}								
