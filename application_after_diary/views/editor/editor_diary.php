              ...
              <div class="col-md-12 ">                         
                ...
                ?>
                  <div class="row" style="margin-bottom:10px;">  
                    <label for="inputEmail3" class="col-md-2 ">E.V</label>
                    <div class="col-md-2">
                      <input type="text" class="form-control" id="ev" placeholder="0">
                    </div>
                  </div>

                  <div class="row" style="margin-bottom:10px;">  
                    <label for="inputPassword3" class="col-md-2 control-label">T.R</label>
                    <div class="col-md-2">
                      <input type="text" class="form-control" id="tr" placeholder="0">
                    </div>
                  </div>
                
                  <div class="row" style="margin-bottom:10px;">  
                    <label for="inputPassword3" class="col-md-2 control-label">S.R</label>
                    <div class="col-md-2">
                      <input type="text" class="form-control" id="sr" placeholder="0">
                    </div>
                  </div>

                  <div class="row" style="margin-bottom:10px;">  
                    <label for="inputEmail3" class="col-md-2 control-label">Co</label>
                    <div class="col-md-2">
                      <input type="text" class="form-control" id="co" placeholder="0">
                    </div>
                  </div>
                  <? }else{ // Draft,T.B.D,Completed                    
...
{     
  ...
  //var scoring = '{"EV":"'+ev+'","TR":"'+tr+'","SR":"'+sr+'","Co":"'+co+'"}';
  var scoring = JSON.stringify({EV: ev, TR: tr, SR: sr, Co: co});  
  var data = {            
    essay_id: <?=$id;?>,            
    editing: editing,
