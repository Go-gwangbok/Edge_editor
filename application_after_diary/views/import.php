<div class="container" style="margin-top:-15px;">			
	<div class="row">		
		<ol class="breadcrumb" style="background:white;">
    		...
    		<li class="akacolor">Import </li>   
  		</ol>		
  		<h3 class="text-center"><?=$pj_name->name;?></h3>
...
{	
	...
	if(cate == 'import'){
		url = '/import/import_mem_dis_proc';
	}else{
		url = '/import/mem_dis_proc';
	}
	...
	$.ajax({
        ...
        success: function(json) {
            ...
            if(json['result']) {            	
            	window.location.replace('/musedata/project/import/'+json['pj_id']); // 리다이렉트할 주소
            }
            else
            {
...
$("button#distribute").click(function(){
	var total_essay_count = '<?=$cou;?>'; // total count 단순히 import된 에세이 카운터.
	var pj_id = $('input#pj_id').val();
	var data = {
		total_essay_count: total_essay_count, // 총 에세이 카운터!
		pj_id: pj_id
	};		
	console.log(data);
	$('#modal').modal('show');	
