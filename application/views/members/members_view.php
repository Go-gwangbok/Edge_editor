<div class="container" style="margin-top:-15px;">	
    ...
    <div class="row">
    	...
    	foreach ($memlist as $value) {
            ...
            if($total > 0){
                $pecent = round(($done_count/($total-$tbd))*100);         
                $pecent_other = round(($done_count/($total-$tbd))*100,1);             
            }else{
                $pecent = 0;
                $pecent_other = 0;
            }		    
    		...
    		<div class="col-md-12 line" style="height:110px; margin-bottom:20px;">
    			...
    			<div class="col-md-6">
    				<div class="col-md-12 text-center" style="height:30px; padding-top:5px;">
    					<a href="/musedata/project/board/tbd/<?=$pj_id;?>/<?=$usr_id;?>">
    			...
    			<div class="col-md-6">
    				<div class="col-md-12 text-center" style="height:30px; padding-top:5px;">
    					<a href="/musedata/project/board/history/<?=$pj_id;?>/<?=$usr_id;?>">
