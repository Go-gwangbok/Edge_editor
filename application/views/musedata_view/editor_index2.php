    ...
    $.each(result,function(i,values){
      ...
      $('div#chart').append('<div class="col-lg-3" style="margin-bottom:20px;">'
                              +'<div class="col-lg-12 line">'
                                +'<h5 class="editor_pj_btn" style="margin-top:10px;"><span class="glyphicon glyphicon-flag"></span> '+pj_name+'</h5>'
                                +'<h6 class="text-right editor_pj_btn" style="margin-top:-5px;">'+date+'</h6>'
                              +'</div>'                              
                              +'<div class="col-lg-12 line disc" style="height:180px;" >'
                                +'<canvas style="margin-left:28px; margin-top:5px; cursor: pointer;" id="pjc'+i+'" width="170" height="170"></canvas>'
                                  +'<p style="margin-top:-100px; margin-left:87px; font-size:17px;">'+avg.toFixed(1)+'%</p>'                                  
                                +'</div>'
                              +'<div class="col-lg-6 service_bg editor_index_btn href" style="height:60px; margin-left:-1px;" href="/musedata/project/board/todo/'+pj_id+'/'+usr_id+'">'
                                +'<p class="font-white text-center" style="margin-top:15px;">Enter</p>'
                              +'</div>'
                              +'<div class="col-lg-6 service_bg editor_index_btn text-center" style="height:60px; margin-left:1px; opacity:0.4">'
                                +'<p class="font-white text-center" style="margin-top:15px;">Stats</p>'
                              +'</div>'
                            +'</div>');
