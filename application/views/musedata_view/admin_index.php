<div class="container" style="margin-top:-15px;">   
  <div class="row">    
      ...
      <h3 style="margin-left:13px;">Muse Project List
        ...
        <?php } ?>       
        <a class="btn btn-default btn-sm pull-right" href="/musedata/project/score_stats" id="new_pj" role="button" style="border-color:#6799FF; color:#6799FF; margin-right:15px;">Score Stats</a>
      </h3>  
      ...
      $('div#chart').append('<div class="col-lg-4" style="margin-bottom:20px;">'
                              +'<div class="col-lg-12 line">'                                
                                +'<h4 style="margin-top:13px;" class="akacolor"><span class="glyphicon glyphicon-list-alt"></span> '+pj_name
                                  ...
                                  +'</button>'
                                +'</h4>'                                
                                +'<h6 class="text-right akacolor">'+kind.toUpperCase()+'&nbsp;&nbsp;&nbsp;'+date+'</h6>'
                              +'</div>'                              
