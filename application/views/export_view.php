	...
	$.post(url,data,function(json) {				
		...
		if(cate == 'error_export'){
			...
			for(var i = 0; i < json['history_totalcount'].length; i++){
				...
				var raw_txt = history_list[i]['raw_txt'];
				var kind_name = history_list[i]['kind_name'];
				var kind = history_list[i]['kind'];
...
$('button#allexport').click(function(){		
	...
	console.log(data);
	var download_url  = '/musedata/project/all_export?done='+ pj_id +'&pj_name='+pj_name;
