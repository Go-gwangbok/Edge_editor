<div class="container" style="margin-top:-15px;">		
	<div class="row">		
	    ...
	    <div id="error">	    	
			<button class="btn btn-danger pull-right" id="allexport" style="margin-top:-15px; margin-right:1px;" disabled> Export <span class="badge" id="allcount" style="background-color:transparent;">00</span><span class="glyphicon glyphicon-download"></span>
			</button> 							
