<div class="container" style="margin-top:-15px;">	
    ...
    <div class="row">
        ...
        foreach ($services as $value) {
            if ($value->type != 'service') continue;
            $ser_name = $value->name;
            $ser_id = $value->id;
        ?>
        <div class="col-md-4">                      
            <div class="col-md-8 line font-white" id="set_type" href="/service/<?=$ser_name;?>" style="height:150px; margin-left:40px; background-color:#9FC93C; cursor:pointer;">
                <br/>
