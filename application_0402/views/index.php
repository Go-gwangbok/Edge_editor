                        ...
                        <div class="widget-content" style="margin-top:15px;">                            
                            <div class="pull-center">                                
                                ...
                                if($this->session->userdata('is_login')){                                
                                    ...
                                    <div class="col-md-4 line" id="new_editor" href="/members/info" style="height:70px; cursor:pointer;border-color:black;">                                    
    ...
    $.ajax({
            ...
            success: function(json) {
                    ...
                    if(json['new_editor']){
                        ...
                        //$('div#new_editor').attr('disabled',false);                        
                        $('div#new_editor').css('background-color','#F15F5F');
                        //$('div#new_editor').css('border-color','#F15F5F');
