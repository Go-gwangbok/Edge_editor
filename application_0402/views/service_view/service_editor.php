<div class="container" style="margin-top:-15px;">
  <div class="row">   
    <ol class="breadcrumb" style="background:white;">
        ...
        ?>
        <li><a href="/service/enter/<?=$month;?>/<?=$year?>"><?=$year.' - '.$str_month?></a></li>                
        <li><a href="/service/member_enter/<?=$month;?>/<?=$year?>/<?=$usr_id?>">Completeds</a></li>                
        <li class="akacolor">Data</li>
        <?
          }elseif($classify == 'export'){
        ?>
