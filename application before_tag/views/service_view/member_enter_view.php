<div class="container" style="margin-top:-15px;">		
	<div class="row">		
		<ol class="breadcrumb" style="background:white;">
		    ...
		    <li><a href="/service/enter/<?=$int_month?>/<?=$year?>"><?=$year.' - '.$str_month?></a></li>   		    
...
function ajaxPost(url,data){
	$.post(url,data,function(json) {				
		...
		for(var i = 0; i < json['data_list'].length; i++) {
			...
			$('tbody#list').append('<tr id='+i+'  style="cursor:pointer;" class="rowbtn" href="/text_editor/service_comp/completed/'+essay_id+'/'+task+'/'+month+'/'+year+'"><td class="text-center">'+num+'</td><td>'																				 
				...
				+data_list[i]['type']+'</td><td width="80px;" class="text-center"><button class="btn btn-success btn-sm">Completed</button></td>');					
			num++;			
		}								
