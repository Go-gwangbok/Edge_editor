	...
	$.post(url,data,function(json) {				
		...
		if(cate == 'tbd'){ // T.B.D
			for(var i = 0; i < json['list'].length; i++) {
				...
				$('tbody#list').append('<tr id='+i+' class="clickableRow" style="cursor:pointer;" href="/text_editor/essays/tbd/'+essay_id+'/'+task+'/'+pj_id+'"><td class="text-center">'+num+'</td><td>'																				 
			...
			for(var i = 0; i < json['list'].length; i++) {
				...
				$('tbody#list').append('<tr id='+i+' class="clickableRow" style="cursor:pointer;" href="/text_editor/essays/history/'+essay_id+'/'+task+'/'+pj_id+'"><td class="text-center">'+num+'</td><td>'																				 
					+prompt.replace(/"/gi,'')+'</td><td class="text-center">'
					+data_list[i]['kind']+'</td><td class="text-center">'
					+date+'</td><td class="text-center">'
					+data_list[i]['type']+'</td>');						
